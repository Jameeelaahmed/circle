...
import { generateIrregularCirclePath, generatePathLayers } from "./utils/pathUtils"
...
export default function LandingIrregularCirclePaths() {
    ...
    return (
        <div className="inset-0 overflow-hidden flex justify-center opacity-30 transform scale-[0.85]"> {/* Reduced size */}
            <svg
