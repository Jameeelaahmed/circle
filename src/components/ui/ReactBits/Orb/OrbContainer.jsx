...
// Components
import OrbPersentational from "./OrbPersentational";
function OrbContainer({
  ...
  const frag = /* glsl */ `
        ...
        vec4 draw(vec2 uv) {
          // Use base colors directly without hue adjustment to preserve primary color scheme
  ...
  }, [hue, hoverIntensity, rotateOnHover, forceHoverState, imageUrl]);
