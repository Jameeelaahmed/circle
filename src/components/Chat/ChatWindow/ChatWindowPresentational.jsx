...
function ChatWindowPresentational({
  ...
  return (
    <div className="flex h-full min-h-0 max-w-full flex-col overflow-hidden bg-white/5 shadow-lg ltr:rounded-tr-3xl ltr:rounded-br-3xl rtl:rounded-tl-3xl rtl:rounded-bl-3xl">
