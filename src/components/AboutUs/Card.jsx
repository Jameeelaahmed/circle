  ...
  return (
    <div className="flex flex-col [perspective:800px]">
      <div
        ...
        className="group relative grid w-[300px] grid-rows-[250px_120px_40px] rounded-md bg-white/5 backdrop-blur-3xl p-4 text-primary transition-transform ease-out hover:[transform:rotateX(var(--x-rotation))_rotateY(var(--y-rotation))_scale(1.1)] shadow-gray-700/20 shadow-2xl"
      >
        <figure>
